...
public class VideoFGeneratedPage extends Basepage {
    public VideoFGeneratedPage(ThreadLocal<WebDriver> driver) {
        super(driver);
    }
     ...
     Actions act=new Actions(driver);
	    ...
	    @FindBy(xpath="//div[@class='flex gap-3']//div[text()='Like']/..") 
	  ...
	  //button[@data-testid='like']//*[name()='svg']/../..//button[contains(@class, 'bg-nyx-sky')]
	    ...
	    @FindBy(xpath="//div[@class='flex gap-3']//div[text()='Dislike']/..") 
	    WebElement dislikebutton;
	    
	    @FindBy(xpath="//div[@class='flex gap-3']//div[text()='Dislike']/..//button[contains(@class, 'bg-nyx-sky')]") 
